...
import { Music, Trophy, Search, User, Menu, X, Shield, CreditCard, Users, Download } from "lucide-react";
    ...
    <header className="fixed top-0 left-0 right-0 z-50 glass pt-[env(safe-area-inset-top,0px)]">
      <div className="container flex h-14 sm:h-16 items-center justify-between px-3 sm:px-4 lg:px-6">
        <Link to="/" className="flex items-center gap-2">
          ...
          <span className="font-display text-base sm:text-lg font-bold tracking-tight truncate max-w-[200px] sm:max-w-none">
            Weekly Music Awards
          </span>
        </Link>
