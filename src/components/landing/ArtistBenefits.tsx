    ...
    <section className="py-20 md:py-28 relative overflow-hidden">
      ...
      <div className="container px-6 relative">
        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {benefits.map((b, i) => (
            <motion.div key={i} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: i * 0.08 }} className={`group rounded-2xl border border-border bg-gradient-to-br ${b.gradient} p-6 transition-all hover:shadow-lg hover:-translate-y-1`}>
