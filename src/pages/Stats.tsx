...
const Stats = () => {
  ...
  return (
    <Layout>
      <SEOHead
        title="Statistiques"
        description="Decouvrez les statistiques en temps reel du concours musical Weekly Music Awards."
        url="/stats"
      />
      <div className="container py-8">
        <div className="mb-8">
          <h1 className="font-display text-3xl font-bold sm:text-4xl">Statistiques</h1>
          <p className="mt-2 text-muted-foreground">{weekTitle} — Donnees en temps reel</p>
        </div>
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <h2 className="font-display text-xl font-semibold">Pas de donnees disponibles</h2>
            <p className="mt-2 text-muted-foreground">
              Les statistiques seront disponibles des le debut de la prochaine competition.
            </p>
          </div>
        ) : (
              ...
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}>
                <Card>
                  <CardContent className="py-6 text-center">
                    ...
                    <p className="text-xs text-muted-foreground">Morceaux en competition</p>
                  </CardContent>
                </Card>
              </motion.div>
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}>
                <Card>
                  <CardContent className="py-6 text-center">
                    ...
                    <p className="text-xs text-muted-foreground">Categorie la plus votee</p>
                  </CardContent>
                </Card>
              </motion.div>
            </div>
