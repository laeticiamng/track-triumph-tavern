...
const Terms = () => {
  ...
  return (
    <Layout>
      <SEOHead title={t("legal.termsTitle")} description={t("legal.termsSeoDesc")} url="/terms" />
      <div className="container max-w-3xl py-8 sm:py-12 px-4 sm:px-6">
        <h1 className="font-display text-2xl sm:text-3xl font-bold mb-6 sm:mb-8">{t("legal.termsTitle")}</h1>
