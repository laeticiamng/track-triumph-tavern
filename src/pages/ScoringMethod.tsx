...
const ScoringMethod = () => (
  <Layout>
    <SEOHead title="Methode de notation" description="Decouvrez comment le classement est calcule sur Weekly Music Awards : criteres, ponderation et anti-fraude." url="/scoring-method" />
